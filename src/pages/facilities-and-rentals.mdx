...
subtitle: "A retreat center, private apartments, a dormitory, a pavilion, a pool — in the heart of the Sonoran Desert."
description: "Desert Rose Institute facilities and rental information — retreat center, casas, dormitory, pavilion, pool, RV park, campsite."
image: casas
---
...
<p class="not-prose"><a href="/calendar" class="inline-flex items-center gap-2 text-brand font-medium hover:underline">📅 See the DRBI calendar &amp; open dates →</a></p>
