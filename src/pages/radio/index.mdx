...
<div class="flex flex-wrap w-full justify-evenly">
  ...
  <div class="card w-64 text-center mx-2 ">
    <img {...romanimg} class="rounded-full w-48 mx-auto mb-2" />
    <h3 class="name mb-0 mt-0"> Roman Orona </h3> <p class="title mt-0 text-sm"> Indigenous Cafe </p>
  </div>

  <div class="card w-64 text-center  px-2 ">
    <img {...melodyimg} class="rounded-full w-48 mx-auto mb-2" />
    <h3 class="name mb-0 mt-0"> Melvin Banning </h3> <p class="title mt-0 text-sm"> Classic Rock </p>
  </div>

  <div class="card w-64 text-center  px-2 ">
    <img {...rickimg} class="rounded-full w-48 mx-auto mb-2" />
    <h3 class="name mb-0 mt-0"> Rick Rock </h3> <p class="title mt-0 text-sm"> Club Mix </p>
  </div>

  <div class="card w-64 text-center  mx-2 ">
    <img {...helenaimg} class="rounded-full w-48 mx-auto mb-2" />
